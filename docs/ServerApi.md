...
# **server_create**
> IpamsvcCreateServerResponse server_create(body)
...
api_instance = bloxoneipam.ServerApi(bloxoneipam.ApiClient(configuration))
body = bloxoneipam.IpamsvcServer() # IpamsvcServer | 
...
# **server_read**
> IpamsvcReadServerResponse server_read(id, fields=fields)
...
# **server_update**
> IpamsvcUpdateServerResponse server_update(id, body)
