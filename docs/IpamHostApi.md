...
# **ipam_host_create**
> IpamsvcCreateIpamHostResponse ipam_host_create(body)
...
try:
    # Create the IPAM Host object.
    api_response = api_instance.ipam_host_create(body)
    pprint(api_response)
...
try:
    # Delete the IPAM Host object.
    api_instance.ipam_host_delete(id)
except ApiException as e:
...
# **ipam_host_read**
> IpamsvcReadIpamHostResponse ipam_host_read(id, order_by=order_by, fields=fields)
...
try:
    # Read the IPAM Host object.
    api_response = api_instance.ipam_host_read(id, order_by=order_by, fields=fields)
    pprint(api_response)
except ApiException as e:
...
# **ipam_host_update**
> IpamsvcUpdateIpamHostResponse ipam_host_update(id, body)
...
try:
    # Update the IPAM Host object.
    api_response = api_instance.ipam_host_update(id, body)
    pprint(api_response)
except ApiException as e:
