...
# **option_code_create**
> IpamsvcCreateOptionCodeResponse option_code_create(body)
...
api_instance = bloxoneipam.OptionCodeApi(bloxoneipam.ApiClient(configuration))
body = bloxoneipam.IpamsvcOptionCode() # IpamsvcOptionCode | 

try:
    # Create the Option Code object.
    api_response = api_instance.option_code_create(body)
    pprint(api_response)
...
try:
    # Delete the Option Code object.
    api_instance.option_code_delete(id)
except ApiException as e:
...
# **option_code_read**
> IpamsvcReadOptionCodeResponse option_code_read(id, fields=fields)
...
try:
    # Read the Option Code object.
    api_response = api_instance.option_code_read(id, fields=fields)
    pprint(api_response)
except ApiException as e:
...
# **option_code_update**
> IpamsvcUpdateOptionCodeResponse option_code_update(id, body)
...
try:
    # Update the Option Code object.
    api_response = api_instance.option_code_update(id, body)
    pprint(api_response)
except ApiException as e:
