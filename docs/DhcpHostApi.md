...
api_instance = bloxoneipam.DhcpHostApi(bloxoneipam.ApiClient(configuration))
...
# **dhcp_host_read**
> IpamsvcReadHostResponse dhcp_host_read(id, fields=fields)
...
try:
    # Read the DHCP Host object.
    api_response = api_instance.dhcp_host_read(id, fields=fields)
    pprint(api_response)
except ApiException as e:
...
# **dhcp_host_update**
> IpamsvcUpdateHostResponse dhcp_host_update(id, body)
...
api_instance = bloxoneipam.DhcpHostApi(bloxoneipam.ApiClient(configuration))
id = 'id_example' # str | An application specific resource identity of a resource
body = bloxoneipam.IpamsvcHost() # IpamsvcHost | 

try:
    # Update the DHCP Host object.
    api_response = api_instance.dhcp_host_update(id, body)
    pprint(api_response)
except ApiException as e:
