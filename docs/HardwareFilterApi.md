...
api_instance = bloxoneipam.HardwareFilterApi(bloxoneipam.ApiClient(configuration))
body = bloxoneipam.IpamsvcHardwareFilter() # IpamsvcHardwareFilter | 
