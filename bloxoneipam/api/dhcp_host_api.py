...
class DhcpHostApi(object):
    ...
    def dhcp_host_read(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dhcp_host_read(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.dhcp_host_read_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.dhcp_host_read_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def dhcp_host_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """Read the DHCP Host object.  # noqa: E501

        Use this method to read a DHCP Host object. A DHCP Host object associates DHCP configuraton with hosts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dhcp_host_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def dhcp_host_update(self, id, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dhcp_host_update(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.dhcp_host_update_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.dhcp_host_update_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def dhcp_host_update_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Update the DHCP Host object.  # noqa: E501

        Use this method to update a DHCP Host object. A DHCP Host object associates DHCP configuraton with hosts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dhcp_host_update_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
